        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="process-image align-items-center">
              <img src="https://img.freepik.com/premium-photo/human-resources-people-networking-concept_31965-1980.jpg" alt="" className="img-fluid w-100 h-100 mx-auto d-block" />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="card rounded-0 card-body p-5 h-100 ">
              ...
              <p className="card-text lh-base mt-3" style={{textAlign:'justify'}}>Achieve seamless integration in resource-intensive partnerships through leading niche markets. Cultivate personalized customer service with innovative concepts. Dynamically enhance resource distribution for cutting-edge customer support. Objectively innovate empowered manufactured products on parallel platforms. Holistically dominate scalable testing procedures for dependable supply chains.</p>
