...
const Overseas = () => {
  return (
    <div>
       <div>
    <Helmet>
      <title>Overseas Recruitment</title>
      <meta name="title" content="Global Campus Recruitment | InRecruit" />
    </Helmet>
      ...
      <section className="container my-5">
        <div className="row">
          ...
          <div className="col-lg-8 col-md-12">
            <div className="card rounded-0 h-100">
              <div className="card-header rounded-0"  style={{backgroundColor:'#0f2239',color:'#fff'}}>
                <h5 className="fw-bold text-center">International Manpower Recruitment</h5>
              </div>
