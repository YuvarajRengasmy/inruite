          ...
          <div className="col-12">
            <div className="about-header">
              <div className="d-flex flex-row gap-3">
                ...
                <div className="about-link">
                  <Link to="/Agriculture" className="text-decoration-none px-3 text-dark small-caps">CivilAgriculture</Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row g-5">
          <div className="col-lg-3 d-none d-lg-block">
            <div className="list-group bg-dark text-white small-caps">
              ...
              <Link to="/Agriculture" className="list-group-item list-group-item-action active">Agriculture</Link>
          ...
          <div className="col-lg-9">
            ...
            <div className="row mt-5">
              <div className="content-head mb-2">
                <h4 className="fw-normal">What is Agriculture?</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Agriculture is the practice of cultivating plants and livestock. The major agricultural products can be broadly grouped into foods, fibres, fuels and raw materials (such as rubber). Food classes include cereals (grains), vegetables, fruits, oils, meat, milk, fungi and eggs...</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Over one-third of the world's workers are employed in agriculture, second only to the service sector, although in recent decades, the global trend of a decreasing number of agricultural workers continues, especially in developing countries where smallholding is being overtaken by industrial agriculture and mechanization...</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Agribusiness - any company that operates within the agriculture industry. This includes not only farms, but the companies that build, sell, and repair the farm equipment, the inspectors that make sure the farm is up to code, and the entire milk industry, from the drive that picks up the fresh milk through the driver that delivers the processed milk to the grocery stores, for example..</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>The agricultural industry, which includes enterprises engaged in growing crops, raising fish and animals, and logging wood, encompasses farms, dairies, hatcheries, and ranches..</p>
                </div>
              </div>
              ...
              <div className="row mt-4 g-2">
                ...
                <h5>Benefits of Working in Agriculture Industry:</h5>
          ...
          <div className="row g-5">
            <div className="col-lg-6">
              <div className="content-head">
                <h4 className="fw-semibold text-uppercase text-center">Jobs in Agriculture Industry</h4>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Agricultural engineer</li>
                    <li className="list-group-item">Agricultural economist</li>
                    <li className="list-group-item">Warehouse Manager</li>
                    <li className="list-group-item">Farm manager</li>
                ...
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Soil and plant scientists</li>
                    <li className="list-group-item">Inventory Manager</li>
                    <li className="list-group-item">Conservation planner</li>
                    <li className="list-group-item">Horticulturist</li>
                    <li className="list-group-item">Nursery/Florist</li>
