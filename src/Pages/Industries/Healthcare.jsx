...
import HealthCare from "../../assets/image/indu/healthcare.jpg"
...
const Healthcare = () => {
    ...
    <Helmet>
      ...
      <meta name="title" content="International healthcare jobs | InRecruit" />
    </Helmet>
      ...
      <div className="card p-0 border-0 rounded-0 image-card" style={{ height: '10rem' }}>
                    ...
                    <div className="col-12">
                        <div className="about-header">
                            <div className="d-flex flex-row gap-3">
                                ...
                                <div className="about-link">
                                    <Link to="/Healthcare" className="text-decoration-none px-3 text-dark small-caps">Healthcare</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row g-5">
                    <div className="col-lg-3 d-none d-lg-block">
                        <div className="list-group bg-dark text-white small-caps">
                            ...
                            <Link to="/Healthcare" className="list-group-item list-group-item-action active">Healthcare</Link>
                    ...
                    <div className="col-lg-9">
                        <div className="content-image mx-auto d-block">
                            <img src={HealthCare} alt="Civil Engineering" className="img-fluid mx-auto d-block" />
                        </div>
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-8">
            <h5 className='my-4'>Benefits of Working in HealthCare Industry:</h5>
            ...
            <div className="border">
              ...
              <div className="tab-content mt-3 h-100" id="myTabContent">
                ...
                <div className="tab-pane fade p-4" id="tab-profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div className="content">
                    <p className="lh-base">Every engagement is overseen by a placement counselor with experience in your field. InRecruit currently works with applicants from a variety of industries, including accounting and finance, legal and compliance, information technology, and corporate support.</p>
                  </div>
                </div>
