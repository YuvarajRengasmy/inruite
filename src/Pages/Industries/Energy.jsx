...
import Indu from "../../assets/image/indu/energy.jpg"
...
const Energy = () => {
    return (
        <div className="Energy">
             <div>
    <Helmet>
      <title>Energy & Resource Industry</title>
      <meta name="title" content="Renewable Energy Jobs Abroad | InRecruit" />
    </Helmet>
                    ...
                    <div className="col-12">
                        <div className="about-header">
                            <div className="d-flex flex-row gap-3">
                                ...
                                <div className="about-link">
                                    <Link to="/Energy-&-Resources" className="text-decoration-none px-3 text-dark small-caps">Energy and resources</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-9">
                        <div className="content-image mx-auto d-block">
                            <img src={Indu} alt="Civil Engineering" className="img-fluid mx-auto d-block" />
                        </div>
                        <div className="row mt-5">
                            <div className="content-head mb-2">
                                <h4 className="fw-normal ">Energy & Resource Industry</h4>
                            </div>
                            <div className="col-lg-12">
                                <div className="content-details">
                                    <p>The energy industry is the totality of all of the industries involved in the production and sale of energy, including fuel extraction, manufacturing, refining and distribution. Modern society consumes large amounts of fuel, and the energy industry is a crucial part of the infrastructure and maintenance of society in almost all countries..</p>
                                </div>
                                <div className="content-details">
                                    <p>Energy companies also make substantial spending on research and development (R&D) to update technology in drilling and processing to improve efficiency and adapt to the changing environmental policies..</p>
                                </div>
                            </div>
                            <div className="content-head mb-2">
                                <h4 className="fw-normal ">Types of Energy Sector Companies</h4>
                            </div>
                            <div className="col-lg-12">
                                <div className="content-details">
                                    <p>Each has a distinct role to play in bringing energy to businesses and consumers. In particular, the energy industry comprises:</p>
                                </div>
                                <div className="content-details">
                                    <p>1. The fossil fuel industries, which include petroleum industries (oil companies, petroleum refiners, fuel transport and end-user sales at gas stations) coal industries (extraction and processing) and the natural gas industries (natural gas extraction, and coal gas manufacture, as well as distribution and sales);.</p>
                                </div>
                                <div className="content-details">
                                    <p>2. The electrical power industry, including electricity generation, electric power distribution and sales;</p>
                                </div>
                                <div className="content-details">
                                    <p>3. The nuclear power industry;</p>
                                </div>
                                <div className="content-details">
                                    <p>4. The renewable energy industry, comprising alternative energy and sustainable energy companies, including those involved in hydroelectric power, wind power, and solar power generation, and the manufacture, distribution and sale of alternative fuels; and,</p>
                                </div>
                                <div className="content-details">
                                    <p>5. Traditional energy industry is based on the collection and distribution of firewood, the use of which, for cooking and heating, is particularly common in poorer countries.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container ">
                ...
                <div className="col-12">
                                <div className="content-head mb-3">
                                    <h4 className=''>Reasons to Work in Energy Sector:</h4>
                            ...
                            <div className="content-card row gy-2">
                                <div className="col-lg-4">
                                    <div className="card border-0 rounded-0 shadow p-4 border-start border-warning border-5 h-100">
                                        <h5 className="card-title text-center fw-semibold">Everyone Uses Energy</h5>
                                       
                                    </div>
                                </div>
                                <div className="col-lg-4">
                                    <div className="card border-0 rounded-0 shadow p-4 border-start border-success border-5 h-100">
                                        <h5 className="card-title text-center fw-semibold">Chance to Innovate</h5>
                                       
                                    </div>
                                </div>
                                <div className="col-lg-4">
                                    <div className="card border-0 rounded-0 shadow p-4 border-start border-danger border-5 h-100">
                                        <h5 className="card-title text-center fw-semibold">Industry is Growing</h5>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item">Chemical Equipment Operators</li>
                                    <li className="list-group-item">Chemical Plant and System Operators</li>
                                    <li className="list-group-item">Civil Engineers</li>
                                    <li className="list-group-item">Construction and Building Inspectors</li>
                            ...
                            <div className="col-lg-6">
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item">Control and Valve Installers</li>
                                    <li className="list-group-item">Repairers</li>
                                    <li className="list-group-item">Electrical and Electronic Engineering Technicians</li>
