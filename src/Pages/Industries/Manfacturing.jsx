...
import Manu from "../../assets/image/indu/manufacturing.jpg"
...
const Manufacturing = () => {
    ...
    <Helmet>
      ...
      <meta name="title" content="Manufacturing Jobs Abroad | International Recruitment | InRecruit" />
    </Helmet>
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-9">
                        <div className="content-image mx-auto d-block">
                            <img src={Manu} alt="Civil Engineering" className="img-fluid mx-auto d-block" />
                        </div>
                        <div className="row mt-5">
                            ...
                            <div className="col-lg-12">
                                <div className="content-details">
                                    <p>Manufacturing, any industry that makes products from raw materials by the use of manual labour or machinery and that is usually carried out systematically with a division of labour. In a more limited sense, manufacturing denotes the fabrication or assembly of components into finished products on a fairly large scale..</p>
                                </div>
                                <div className="content-details">
                                ...
                                <div className="content-details">
                                    <p>Manufacturing processes are changing, and so are the job skills that are needed. Manufacturers are always searching for more cost-effective ways of producing their goods. That's why, even though the number of jobs is projected to decline, the jobs that remain are likely to be higher paid..</p>
                                </div>
                            </div>
                            <div className="content-head mb-2">
                            ...
                            <div className="col-lg-12">
                                <div className="content-details">
                                    <p>Duties include checking and weighing raw materials, ensuring that machine settings are correct, maintaining a clean production environment, running quality checks on, for example, the size and weight of the finished product, assembling, packaging and labelling, and simple machine maintenance.</p>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Manufacturing Manager</li>
                                    <li className="list-group-item">Cost Estimator</li>
                                    <li className="list-group-item">Assembly Team Leader</li>
                                    <li className="list-group-item">Entry Level Manufacturing Engineer</li>
                                    <li className="list-group-item">Food Processing Operators</li>
                                   
                                </ul>
                            </div>
                            <div className="col-lg-6">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Assemblers and Fabricators</li>
                                    <li className="list-group-item">Semiconductor Processors</li>
                                    <li className="list-group-item">Quality Control</li>
                                    <li className="list-group-item">Welders, Cutters, Solderers</li>
                                    <li className="list-group-item">Power Plant Operators</li>
