...
import Travel from "../../assets/image/indu/logistics.jpg";
import Header from '../../Components/Header/Header';
import Footer from '../../Components/Footer/Footer';
import { Helmet } from 'react-helmet';
const Distribution  = () => {
  return (
    <div className="Distribution-Logistics">
       <div>
    <Helmet>
      <title>Distribution Logistics</title>
      <meta name="title" content="International Logistics Jobs | Global Distribution | InRecruit " />
    </Helmet>
  ...
  <div className="container-fluid mb-4">
    <div className="row">
          ...
          <div className="col-12">
            <div className="about-header">
              <div className="d-flex flex-row gap-3">
                ...
                <div className="about-link">
                  <Link to="/Distribution-&-Logistics" className="text-decoration-none px-3 text-dark small-caps">Distribution & Logistics</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container my-5">
        <div className="row g-5">
          <div className="col-lg-3 d-none d-lg-block">
            <div className="list-group bg-dark text-white small-caps">
              ...
              <Link to="/Distribution-&-Logistics" className="list-group-item list-group-item-action active">Distribution/Logistics</Link>
          ...
          <div className="col-lg-9">
            ...
            <div className="row mt-5">
              <div className="content-head mb-2">
                <h4 className="fw-normal">What is Distribution Logistics?</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Distribution logistics, also known as sales logistics, deals with the planning, realisation and control of the movement of goods. It is an inter-organisational logistics system, where the aim is to make the logistics channel from the supplier to the customer efficient – especially in terms of costs and performance....</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>As the link between production and sales of a company, distribution logistics includes all storage, handling and transport processes of goods from production to the customer. In concrete terms, distribution logistics deals with the processes necessary to get a company’s products to the customer as quickly as possible. To this end, distribution logistics is divided into strategic, tactical and operational tasks....</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Distribution logistics comprises the planning tasks, control and all processes concerning the flow of goods and information between production companies and customers..</p>
                </div>
              </div>
              <div className="content-head mb-2">
                <h4 className="fw-normal">Tasks of sales logistics</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Transport logistics comprises three fields of activity:</p>
                  <p>1. Operational control: Operational tasks refer to the processing of orders, shipping, returns management, route planning and customer service...</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>2. Tactical control:Tactical tasks include fleet management, defining minimum purchase quantities, defining a service level and deciding whether the company should manage transport logistics on its own or resort to external providers...</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>3. Strategic control: Strategic tasks include the planning of marketing strategies, the development of distribution networks, the choice of location and both horizontal and vertical networking..</p>
                </div>
              </div>
              <div className="col-12">
                  <div className="content-head">
                   <h3>Roles & Responsibilities</h3>
                    <p>1. Facility and mobile equipment maintenance</p>
                    <p>2. Health, safety and environmental management</p>
                    <p>3. Logistics planning and management services</p>
                    <p>4. Sales and services</p>
                    <p>5. Transportation operations</p>
                    <p>6. Transportation systems and infrastructure planning</p>
                    <p>7. Planning, management and regulation.</p>
        ...
        <div className="container ">
          <div className="row g-5">
          <h5>Benefits of Working in Logistics Industry:</h5>
            ...
            <div className="col-lg-6">
              <div className="content-head">
                <h4 className="fw-semibold text-uppercase text-center">Jobs in Logistics Industry</h4>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item">Logistics Manager</li>
                    <li className="list-group-item">Warehouse Manager</li>
                    <li className="list-group-item">Shipping Manager</li>
                ...
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Purchasing Manager</li>
                    <li className="list-group-item">Inventory Manager</li>
                    <li className="list-group-item">Consultant</li>
                    <li className="list-group-item">Analyst</li>
                    <li className="list-group-item">Logistics Engineer</li>
