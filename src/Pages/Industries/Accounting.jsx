...
import Travel from "../../assets/image/indu/accounting.jpg";
import Header from '../../Components/Header/Header';
import Footer from '../../Components/Footer/Footer';
import { Helmet } from 'react-helmet';
const  Accounting = () => {
  return (
    <div className="Operational-Accounting">
       <div>
    <Helmet>
      <title>Operational Accounting</title>
      <meta name="title" content="Accounting and Operations Jobs Abroad  | InRecruit" />
    </Helmet>
        ...
        <div className="row g-5">
          <div className="col-lg-3 d-none d-lg-block">
            <div className="list-group bg-dark text-white small-caps">
              ...
              <Link to="/Accounting-Operations" className="list-group-item list-group-item-action active">Accounting/Operations</Link>
          ...
          <div className="col-lg-9">
            ...
            <div className="row mt-5">
              <div className="content-head mb-2">
                <h4 className="fw-normal">What Is Operational Accounting?</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Operational accounting is concerned with the financial aspects of running a company. The three main areas of focus are planning, directing and controlling. An operational accountant analyzes the impact of the company's daily activities on the balance sheet and reviews current accounting processes to find problem areas or inefficiencies..</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>For future projections, the accountant can run reports to test possible scenarios before management makes any final decisions. Depending on the size of the company, the operational accountant may be an in-house employee or work as an independent contractor.</p>
                </div>
              </div>
              <div className="content-head mb-2">
                <h4 className="fw-normal">Types of Accounting</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Financial Accounting - Financial accounting refers to the processes used to generate interim and annual financial statements. The results of all financial transactions that occur during an accounting period are summarized into the balance sheet, income statement and cash flow statement. The financial statements of most companies are audited annually by an external CPA firm. For some, such as publicly-traded companies, audits are a legal requirement.6 However, lenders also typically require the results of an external audit annually as part of their debt covenants. Therefore, most companies will have annual audits for one reason or another.</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Managerial Accounting - Managerial accounting uses much of the same data as financial accounting, but it organizes and utilizes information in different ways. Namely, in managerial accounting, an accountant generates monthly or quarterly reports that a business's management team can use to make decisions about how the business operates. Managerial accounting also encompasses many other facets of accounting, including budgeting, forecasting and various financial analysis tools. Essentially, any information that may be useful to management falls underneath this umbrella.</p>
                </div>
              </div>
             
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Cost Accounting - Just as managerial accounting helps businesses make decisions about management, cost accounting helps businesses make decisions about costing. Essentially, cost accounting considers all of the costs related to producing a product. Analysts, managers, business owners and accountants use this information to determine what their products should cost. In cost accounting, money is cast as an economic factor in production, whereas in financial accounting, money is considered to be a measure of a company's economic performance..</p>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Cost accountant</li>
                    <li className="list-group-item">Cost clerk</li>
                    <li className="list-group-item">Cost controller</li>
                    <li className="list-group-item">Finance manager</li>
                    <li className="list-group-item">Financial analyst</li>

                  </ul>
                </div>
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Financial controller</li>
                    <li className="list-group-item">Financial investment advisor</li>
                    <li className="list-group-item">Financial Accountant</li>
                    <li className="list-group-item">Auditor</li>
                    <li className="list-group-item">Tax Accountant</li>
