...
import Travel from "../../assets/image/indu/automobile.jpg";
...
const Automobile = () => {
  return (
    ...
    <Helmet>
      ...
      <meta name="title" content="Automobile Jobs In Overseas | InRecruit" />
    </Helmet>
          ...
          <div className="col-12">
            <div className="about-header">
              <div className="d-flex flex-row gap-3">
                ...
                <div className="about-link">
                  <Link to="/Automobile" className="text-decoration-none px-3 text-dark small-caps">Automobile</Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row g-5">
          <div className="col-lg-3 d-none d-lg-block">
            <div className="list-group bg-dark text-white small-caps">
              ...
              <Link to="/Automobile" className="list-group-item list-group-item-action active">Automobile</Link>
          ...
          <div className="col-lg-9">
            ...
            <div className="row mt-5">
              <div className="content-head mb-2">
                <h4 className="fw-normal">What Is Automobile Industry?</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>The automotive industry comprises a wide range of companies and organizations involved in the design, development, manufacturing, marketing, and selling of motor vehicles. It is one of the world's largest industries by revenue. The automotive industry does not include industries dedicated to the maintenance of automobiles following delivery to the end-user, such as automobile repair shops and motor fuel filling stations.</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Automobile industry, the business of producing and selling self-powered vehicles, including passenger cars, trucks, farm equipment, and other commercial vehicles. By allowing consumers to commute long distances for work, shopping, and entertainment, the auto industry has encouraged the development of an extensive road system, made possible the growth of suburbs and shopping centres around major cities, and played a key role in the growth of ancillary industries, such as the oil and travel businesses...</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>The auto industry has become one of the largest purchasers of many key industrial products, such as steel. The large number of people the industry employs has made it a key determinant of economic growth..</p>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>Each department offers advancement opportunities and careers to fit your personality and passion. Jobs in the automotive industry can teach you new skills, allow you to work in a high-tech work environment with long-term job security, and provide you with competitive wages and benefits.</p>
                </div>
              </div>
              <div className="content-head mb-2">
                <h4 className="fw-normal">What are the departments in the automobile industry?</h4>
              </div>
              <div className="col-lg-12">
                <div className="content-details">
                  <p>The sales department, Management and Administration department, service department and the parts department are the four major departments involved in the automotive industry.</p>
                </div>
              </div>
              ...
              <div className="row mt-4 g-2">
                ...
                <h5>Benefits of Working in Automobile Industry:</h5>
          ...
          <div className="row g-5">
            <div className="col-lg-6">
              <div className="content-head">
                <h4 className="fw-semibold text-uppercase text-center">Jobs in Automobile Industry</h4>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Sales Operations</li>
                    <li className="list-group-item">Sales consultant</li>
                    <li className="list-group-item">Guest Relations</li>
                    <li className="list-group-item">Corporate Sales</li>
                    <li className="list-group-item">Car detailer</li>

                  </ul>
                </div>
                <div className="col-lg-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">Car rental agent</li>
                    <li className="list-group-item">Tire technician</li>
                    <li className="list-group-item">Vehicle inspector</li>
                    <li className="list-group-item">Auto mechanic</li>
                    <li className="list-group-item">Repair technician</li>
