...
export const About = () => {
  return (
    <>
            ...
            <div className="about-header">
              <div className="d-flex flex-row gap-3">
                ...
                <div className="about-link">
                  <Link to="/About" className="text-decoration-none " style={{ color: '#0f2239',fontVariant:'all-small-caps',fontSize:'18px' }}>About</Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card border-0 rounded-0 shadow h-100">
              ...
              <div className="card-body px-4 py-4">
                <p className='card-text lh-base' style={{ textAlign: 'justify' }}>
                  InRecruit HR Services Private Limited is one of the top Human Resource(HR) consultants, providing specialist advice and services to help businesses maximise the efficiency of their HR operations and implement appropriate new policies and procedures in the best way possible.
                </p>
      ...
      <div className="container my-5" style={{ backgroundColor: '#0f2239', color: '#fff' }}>
        <div className="row g-4">
        ...
        <div className="row">
          <div className="col-12">
            <div className="container">
              <h3 className="lh-base h2">We help boost corporate performance by supporting management with the tools they need to deliver.</h3>
              <p className="lh-base px-5">Doubting the positive effects of our teamwork because you’ve been burned before? By working together with the clients, we learn that wins and losses affect everyone on the team. When teams work together, they can discuss and share a variety of perspectives of a situation.</p>
              <p className="lh-lg px-5">It’s easy. Start by registering with us, which will give us the information we need to match you with a position that best fits your skills and background.</p>
              <p className="lh-lg px-5">Alternatively, you can contact us by emailing your resume or calling our corporate office to speak with a placement counsellor.</p>
